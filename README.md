...
Areas for future improvement would be to further populate our database with relevant information, create a log in system so professors can submit their ratings about each tech solution and add comments, and also build a better UI.
